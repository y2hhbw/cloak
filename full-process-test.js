// Full process test to simulate the complete encode and decode process
...
// Simulate the complete encode and decode process
function simulateFullProcess() {
  ...
  // Store binary data in pixels starting from pixel 8
  ...
  for (let i = 0; i < bitsToRead; i++) {
    const pixelIndex = Math.floor((i + 32) / 3) * 4 + 32; // 从长度信息后开始，从第8个像素后开始
    const channelIndex = i % 3;
